...
function App() {
  ...
  return (
    <div className="App divide-y-2 divide-gray-400 bg-zinc-200">
      <h1 className="p-3 text-center drop-shadow-lg font-times font-bold text-6xl mb-3">
        News App
      </h1>
      {loading && <div className="flex w-full items-center justify-center h-screen"><Orbit size={35} color="#231F20" /></div>}
